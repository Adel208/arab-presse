        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h3 className="text-white text-xl font-black mb-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 rounded-xl flex items-center justify-center shadow-medium">
                <span className="text-white text-lg font-black">ع</span>
              </div>
              <span className="bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent">بوابة الأخبار</span>
            </h3>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              ...
              <a href="#instagram" className="w-11 h-11 bg-pink-600 rounded-full flex items-center justify-center hover:bg-pink-700 hover:scale-110 transition-all duration-300 shadow-medium hover:shadow-large">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#youtube" className="w-11 h-11 bg-red-600 rounded-full flex items-center justify-center hover:bg-red-700 hover:scale-110 transition-all duration-300 shadow-medium hover:shadow-large">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
